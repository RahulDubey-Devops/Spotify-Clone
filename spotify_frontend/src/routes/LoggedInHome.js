...
function LoggedInHome() {
    ...
    return (
        <div className="w-full h-full bg-app-black">
            ...
            <div className="flex w-full h-9/10 bg-black">
            ...
            <div className="w-full h-1/10 bg-black opacity-30 text-white flex items-center px-4">
                <div className="w-1/4 flex items-center">
                    <img src="" alt="current Song" className="h-14 w-14 rounded-full "></img>
                    <div className="pl-4">
                        <div className="text-sm text-white ">Curtains</div>
                        <div className="text-gray-500 text-xs cursor-pointer hover:underline">ED Sharn
                        </div>
                    </div>
                </div>
